...
#Domaci 1, unaprijediti particle.py
...
class particle:
    ...
    def total_time(self): #ukupno vrijeme trajanja gibanja
        t = 0
    ...
    def max_speed(self): #najveća ostvarena brzina
        while self.y[-1] >= 0 and len(self.y) == 1 and len(self.y) == 0:
            self.__move()
        return max(self.vy)


    def velocity_to_hit_target(self, mx, my, r): #za zadani kut izračuna potrebnu brzinu za pogoditi kuglicu
        self.mx = mx
        self.my = my
        self.r = r
        d_list = []
    ...
    def angle_to_hit_target(self, mx, my, r): #za zadanu početnu brzinu računa kut otklona koji je potreban za pogoditi kuglicu
        self.mx = mx
        self.my = my
        self.r = r
